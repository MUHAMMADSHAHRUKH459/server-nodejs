...
const GOOGLE_SHEET_ID = "1wMAnbAVGU4wcLc4s5qfUPhwDlqXYLl6GioXjjLV5eJo";
let CREDENTIALS;

try {
    CREDENTIALS = JSON.parse(fs.readFileSync("intellibot-creation-m9wj-65cc24633237.json", "utf8"));
} catch (error) {
...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        user: "intellibotcreation459@gmail.com", // Replace with your email
        pass: "akdr tkee bsuz qbja" // Replace with your email password or app password
    }
});
...
app.post("/webhook", async (req, res) => {
    ...
    function hi(agent) {
        ...
        agent.add("Hi! I'm here to assist you as the virtual assistant of Intellibot Creation. could you please tell me your name?");
    }
    ...
    async function lead(agent) {
        ...
        const mailOptions = {
            from: "intellibotcreation459@gmail.com", // Replace with your email
            to: userEmail,
            subject: "Intellibot creation: Confirmation of Information Received",
            html: `
                <div style="font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 20px; text-align: center; border-radius: 8px; max-width: 600px; margin: auto; border: 1px solid #e0e0e0;">
                    <img src="https://media.licdn.com/dms/image/v2/D4E3DAQFy109n7Z9ViQ/image-scale_127_750/image-scale_127_750/0/1738623654459/intellibot_creation_cover?e=1740092400&v=beta&t=n6Pb6zAyCqK0EgtD6Ws1BERvYPXaDmjgnwrT4Ev5bOs" alt="Saylani Roti Bank" style="max-width: 80%; height: auto; margin-bottom: 20px; border-radius: 8px;">
                    ...
                    <p style="font-size: 16px; color: #333; line-height: 1.6;">
                        We have successfully received your information. Our team at <b>Intellibot Creation</b> will be in touch with you shortly to assist you further.
                    </p>
                    <p style="font-size: 16px; color: #333; line-height: 1.6;">
                    ...
                    <p style="font-size: 16px; color: #333; line-height: 1.6; font-weight: bold;">
                        Warm regards,<br>
                        <span style="color: #4CAF50;">Intellibot Creation Team</span>
                    </p>
